                        ...
                        <div class="container mx-auto">
                            <div class="max-w-md mx-auto my-10 bg-white p-5 rounded-md shadow-sm">
                                <div class="text-center">
                                    <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Cadastro de produtos</h1>
                                    <p class="text-gray-400 dark:text-gray-400">Cadastre quantas produtos quiser</p>
                                </div>
                                <div class="m-7">
                                    @if ($errors->any())
                                    <div class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative" role="alert">
                                        ...
                                        Tem alguns problemas com seu cadastro<br>
                                            ...
                                            <br>
                                            @endif
                                            <form action="{{route('registerProduct')}}" method="POST" id="form">
                                                @csrf
